...
class OldPerson(models.Model):
    ...
    phone = models.CharField(verbose_name="电话", max_length=50, blank=True)
    id_card = models.CharField(verbose_name="身份证", max_length=50)
    checkin_date = models.DateTimeField(verbose_name="入院日期", blank=True)
    img_dir = models.CharField(verbose_name='图像目录', max_length=200)
    guardian_name = models.CharField(verbose_name="监护人姓名", max_length=50, blank=True)
    health_state = models.CharField(verbose_name="健康状况", max_length=50, blank=True)
...
class Employee(models.Model):
    ...
    phone = models.CharField(verbose_name="电话", max_length=50, blank=True)
    id_card = models.CharField(verbose_name="身份证", max_length=50)
    checkin_date = models.DateTimeField(verbose_name="入职日期", blank=True)
    img_dir = models.CharField(verbose_name='图像目录', max_length=200)
...
class Volunteer(models.Model):
    ...
    phone = models.CharField(verbose_name="电话", max_length=50, blank=True)
    id_card = models.CharField(verbose_name="身份证", max_length=50)
    checkin_date = models.DateTimeField(verbose_name="访问日期", blank=True)
    img_dir = models.CharField(verbose_name='图像目录', max_length=200)


class Event(models.Model):
    event_type = models.IntegerField(verbose_name="事件类型")
    event_date = models.DateTimeField(verbose_name="事件发送日期", blank=True)
